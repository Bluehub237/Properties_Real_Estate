...
<!-- Mirrored from housa-html-demo.vercel.app/property-details-v4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Oct 2025 12:24:24 GMT -->
...
<body class="body1 b-bg1">
  ...
  <div class="listing-property-area sp1">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <div class="plisting-images-area">
            <div class="img1">
            ...
            <div class="main-content">
              ...
              <div class="botton-heading heading1">
                <h2>Luxury House in Greenville</h2>
                <p>$12,50,000</p>
              </div>
              <p class="location"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
                      ...
                      fill="#1B1B1B" />
                  </svg></span> 2323 Dancing Dove, Long Island City, NY 11101</p>
              <div class="space28"></div>
                  ...
                  <div class="details-siderbar2">
                    ...
                    <div class="personal-info">
                      ...
                      <div class="content">
                        ...
                        <a href="mailto:shagorahmed@.com"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M3 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3ZM20 7.23792L12.0718 14.338L4 7.21594V19H20V7.23792ZM4.51146 5L12.0619 11.662L19.501 5H4.51146Z"></path>
                          </svg>shagorahmed@.com</a>
                        <a href="tel:(234)345-4574"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            <path
                              d="M9.36556 10.6821C10.302 12.3288 11.6712 13.698 13.3179 14.6344L14.2025 13.3961C14.4965 12.9845 15.0516 12.8573 15.4956 13.0998C16.9024 13.8683 18.4571 14.3353 20.0789 14.4637C20.599 14.5049 21 14.9389 21 15.4606V19.9234C21 20.4361 20.6122 20.8657 20.1022 20.9181C19.5723 20.9726 19.0377 21 18.5 21C9.93959 21 3 14.0604 3 5.5C3 4.96227 3.02742 4.42771 3.08189 3.89776C3.1343 3.38775 3.56394 3 4.07665 3H8.53942C9.0611 3 9.49513 3.40104 9.5363 3.92109C9.66467 5.54288 10.1317 7.09764 10.9002 8.50444C11.1427 8.9484 11.0155 9.50354 10.6039 9.79757L9.36556 10.6821ZM6.84425 10.0252L8.7442 8.66809C8.20547 7.50514 7.83628 6.27183 7.64727 5H5.00907C5.00303 5.16632 5 5.333 5 5.5C5 12.9558 11.0442 19 18.5 19C18.667 19 18.8337 18.997 19 18.9909V16.3527C17.7282 16.1637 16.4949 15.7945 15.3319 15.2558L13.9748 17.1558C13.4258 16.9425 12.8956 16.6915 12.3874 16.4061L12.3293 16.373C10.3697 15.2587 8.74134 13.6303 7.627 11.6707L7.59394 11.6126C7.30849 11.1044 7.05754 10.5742 6.84425 10.0252Z">
                            </path>
                          </svg>(234) 345-4574</a>
                      </div>
                    </div>
                    ...
                    <div class="input-area">
                      <button type="submit" class="vl-btn1">View More Property <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></button>
                    </div>
                  </div>
              ...
              <div class="col-lg-9">
                <div class="property-widget-sidebar">
                  ...
                  <div class="padding-side">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="others-box">
                          ...
                          <div class="text">
                            <p><span>Modern Interior & Finishes:</span> High-quality materials and contemporary designs.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="others-box">
                          <img src="assets/img/icons/check1.svg" alt="housa">
                          <div class="text">
                            <p><span>Spacious Layout:</span> Open-concept living areas and well-planned spaces.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="others-box">
                          <img src="assets/img/icons/check1.svg" alt="housa">
                          <div class="text">
                            <p><span> Prime Location:</span> Close to schools shopping, and public transport location.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="others-box">
                          <img src="assets/img/icons/check1.svg" alt="housa">
                          <div class="text">
                            <p><span>Energy Efficient:</span> Equipped with smart home features and sustainable elements.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="others-box">
                          <img src="assets/img/icons/check1.svg" alt="housa">
                          <div class="text">
                            <p><span>Secure & Private: </span> Gated community security features for peace of mind.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="others-box">
                          <img src="assets/img/icons/check1.svg" alt="housa">
                          <div class="text">
                            <p><span>Shopping & Entertainment: </span> Malls, Markets, Entertainment Centers.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="others-box">
                          <img src="assets/img/icons/check1.svg" alt="housa">
                          <div class="text">
                            <p><span>Park & Recreation: </span> Parks Sport Center, Fitness Club, Swimming Center.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="space32"></div>
                    <div class="contact-boxarea ms-0">
                    ...
                    <div class="contact-box">
                      ...
                      <div class="text">
                        <p>Our Email</p>
                        <div class="space8"></div>
                        <a href="#">Housarealestate@gmail.com / or / Housa1255@gmail.com</a>
                      </div>
                    </div>
                    <div class="contact-box">
                    ...
                    <div class="contact-box">
                      ...
                      <div class="text">
                        <p>Visit us</p>
                        <div class="space8"></div>
                        <a href="#">2825 Winding Way, Providence, RI 02908</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="space30"></div>
                <div class="bg1-property">
                  <h3>Map Locations</h3>
                  <div class="space32"></div>
                      ...
                      <div class="comments-auhtor-box">
                        ...
                        <div class="content">
                          <a href="#" class="date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            </svg> 8 December 2025</a>
                          <a href="about-us.html" class="name">Alex Robertson</a>
                        </div>
                      </div>
                    ...
                    <div class="comments-boxes">
                      <div class="comments-auhtor-box">
                        ...
                        <div class="content">
                          ...
                          <a href="about-us.html" class="name">Theo Hernandez</a>
                        </div>
                      </div>
                      <a href="#" class="reply"><i class="fa-solid fa-reply"></i> Reply</a>
                    </div>
                  ...
                  <div class="bg-area">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        <div class="space16"></div>
                        <div class="input-area">
                          <button type="submit" class="vl-btn1">Reply Now <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></button>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="property-single-boxarea">
            ...
            <div class="btn-area1 text-center">
              <a href="#" class="vl-btn1">View Property Details <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
...
<!-- Mirrored from housa-html-demo.vercel.app/property-details-v4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Oct 2025 12:24:25 GMT -->
</html>