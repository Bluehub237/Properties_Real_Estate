      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="inner-header heading1">
            ...
            <p><a href="index.html">Home <svg xmlns="http://www.w3.org/2000/svg" width="9" height="16" viewBox="0 0 9 16" fill="none">
                  <path d="M1.5 1.74997L7.75 7.99997L1.5 14.25" stroke="#1B1B1B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg> Our Blog</a> <svg xmlns="http://www.w3.org/2000/svg" width="9" height="16" viewBox="0 0 9 16" fill="none">
                <path d="M1.5 1.74997L7.75 7.99997L1.5 14.25" stroke="#1B1B1B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg> Blog Details</p>
          </div>
        </div>
          ...
          <div class="blog-siderbar">
            <div class="all-category">
              ...
              <div class="categories-area">
                <h3>Blog Category</h3>
                <ul>
                  <li><a href="#">Home Buying Tips (12) <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <li><a href="#">Home Selling Advice (34) <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M13.1724 12.0013L8.22266 7.05153L9.63687 5.63733L16.0009 12.0013L9.63687 18.3652L8.22266 16.951L13.1724 12.0013Z" fill="#1B1B1B" />
                      </svg></a></li>
                  <li><a href="#">Home Selling Advice (34) <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M13.1724 12.0013L8.22266 7.05153L9.63687 5.63733L16.0009 12.0013L9.63687 18.3652L8.22266 16.951L13.1724 12.0013Z" fill="#1B1B1B" />
                      </svg></a></li>
                  <li><a href="#">Interior Design Décor (12) <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M13.1724 12.0013L8.22266 7.05153L9.63687 5.63733L16.0009 12.0013L9.63687 18.3652L8.22266 16.951L13.1724 12.0013Z" fill="#1B1B1B" />
                      </svg></a></li>
                  <li><a href="#">Lifestyle And Living (34) <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M13.1724 12.0013L8.22266 7.05153L9.63687 5.63733L16.0009 12.0013L9.63687 18.3652L8.22266 16.951L13.1724 12.0013Z" fill="#1B1B1B" />
                      </svg></a></li>
                  <li><a href="#">Property Investment (16) <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M13.1724 12.0013L8.22266 7.05153L9.63687 5.63733L16.0009 12.0013L9.63687 18.3652L8.22266 16.951L13.1724 12.0013Z" fill="#1B1B1B" />
                      </svg></a></li>
                  <li><a href="#">Neighborhood Guides (12) <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M13.1724 12.0013L8.22266 7.05153L9.63687 5.63733L16.0009 12.0013L9.63687 18.3652L8.22266 16.951L13.1724 12.0013Z" fill="#1B1B1B" />
                      </svg></a></li>
                </ul>
              </div>
              ...
              <div class="posts-area">
                ...
                <div class="post-auhtor-area">
                  <div class="img1">
                    <img src="assets/img/all-images/blog/blog-img13.png" alt="housa">
                  </div>
                  <div class="content">
                    <ul>
                      <li>
                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <g clip-path="url(#clip0_6058_73650)">
                      ...
                      <li>
                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <g clip-path="url(#clip0_6058_73657)">
                              <path
                    ...
                    <a href="property-details-v1.html" class="head">Top Real Estate Invest
                ...
                <div class="post-auhtor-area">
                  <div class="img1">
                    <img src="assets/img/all-images/blog/blog-img14.png" alt="housa">
                  </div>
                  <div class="content">
                    <ul>
                      <li>
                ...
                <div class="post-auhtor-area">
                  <div class="img1">
                    <img src="assets/img/all-images/blog/blog-img15.png" alt="housa">
                  </div>
                  <div class="content">
                    <ul>
                      <li>
              ...
              <div class="col-lg-12">
                <div class="blog-post-details-area heading1">
                  ...
                  <ul class="list-author">
                    ...
                    <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="22" viewBox="0 0 21 22" fill="none">
                          <g clip-path="url(#clip0_6063_80620)">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="22" viewBox="0 0 21 22" fill="none">
                          <g clip-path="url(#clip0_6059_80076)">
                            <path
                  ...
                  <div class="vide-images">
                    ...
                    <a href="https://www.youtube.com/watch?v=lXKcNihsUZY" class="popup-youtube"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div class="contact-boxarea">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        ...
                        <div class="input-area">
                          <button type="submit" class="vl-btn1">Leave A Reply Now <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></button>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="col-lg-4  col-md-6" data-aos="fade-left" data-aos-duration="900">
          <div class="vl-blog-1-item">
            ...
            <div class="vl-blog-1-content">
              ...
              <div class="space24"></div>
              <h4 class="vl-blog-1-title"><a href="blog-detail.html">5 Tips For First-Time <br class="d-lg-block d-none"> Homebuyers Housa</a></h4>
              <div class="space24"></div>
              <div class="vl-blog-1-icon">
                <a href="blog-detail.html" class="readmore">Read More <i class="fa-solid fa-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="fade-left" data-aos-duration="1000">
          <div class="vl-blog-1-item">
            ...
            <div class="vl-blog-1-content">
              ...
              <div class="space24"></div>
              <h4 class="vl-blog-1-title"><a href="blog-detail.html">Understanding the Latest Real Estate Market Trends</a></h4>
              <div class="space24"></div>
              <div class="vl-blog-1-icon">
                <a href="blog-detail.html" class="readmore">Read More <i class="fa-solid fa-arrow-right"></i></a>
              </div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-left" data-aos-duration="1000">
          <div class="vl-blog-1-item">
            ...
            <div class="vl-blog-1-content">
              ...
              <div class="space24"></div>
              <h4 class="vl-blog-1-title"><a href="blog-detail.html">How to Stage Your Home for <br class="d-lg-block d-none"> a Quick Sale</a></h4>
              <div class="space24"></div>
              <div class="vl-blog-1-icon">
                <a href="blog-detail.html" class="readmore">Read More <i class="fa-solid fa-arrow-right"></i></a>
              </div>
