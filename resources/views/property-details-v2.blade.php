...
<!-- Mirrored from housa-html-demo.vercel.app/property-details-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Oct 2025 12:24:17 GMT -->
...
<body class="body1 b-bg1">
  ...
  <div class="properties2-others sp1">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
        ...
        <div class="col-lg-12">
          <div class="property-mapgrid-area">
            ...
            <div class="row">
              ...
              <div class="col-lg-9">
                <div class="heading-properties heading1">
                  <div class="row">
                    <div class="col-lg-8">
                      <div class="content-area">
                        ...
                        <div class="space32"></div>
                        <a href="property-details-v1.html" class="title">Luxury House in Greenville</a>
                        <div class="space32"></div>
                        <p><span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 18 22" fill="none">
                              <path
                                ...
                                fill="#1B1B1B" />
                            </svg></span> 179 Sampson Street, Georgetown, CO 80444</p>
                        <div class="space24"></div>
                        <ul>
                          <li><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M8 9H16M8 15H16" stroke="#1B1B1B" stroke-width="1.5" stroke-linejoin="round" />
                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="property-other-widget">
                        ...
                        <div class="space20"></div>
                        <div class="btn-area1">
                          <a href="add-property.html" class="vl-btn1">See Details <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="property-single-boxarea">
            ...
            <div class="btn-area1 text-center">
              <a href="property-details-v1.html" class="vl-btn1">View Property Details <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
...
<!-- Mirrored from housa-html-demo.vercel.app/property-details-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Oct 2025 12:24:21 GMT -->
</html>