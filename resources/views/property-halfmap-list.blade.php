...
<!-- Mirrored from housa-html-demo.vercel.app/property-halfmap-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Oct 2025 12:24:03 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Housa - Real Esate Template </title>
  <!--=====FAB ICON=======-->
...
<body class="body1 b-bg1">
        ...
        <div class="row align-items-center">
              ...
              <nav class="vl-mobile-menu-active">
                <ul>
                  <li class="has-dropdown">
                    ...
                    <div class="vl-mega-menu d-none d-lg-block">
                        ...
                        <div class="row gx-3 row-cols-1 row-cols-md-1 row-cols-lg-4">
                          <div class="col">
                            <div class="vl-home-thumb">
                              ...
                              <a href="index.html">Housa - Homepage 01</a>
                              <div class="btn-area1">
                                <a href="index.html" class="vl-btn1">View Demo <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                              </div>
                          ...
                          <div class="col">
                            <div class="vl-home-thumb">
                              ...
                              <a href="index2.html">Housa - Homepage 02</a>
                              <div class="btn-area1">
                                <a href="index2.html" class="vl-btn1">View Demo <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                              </div>
                              <div class="space20 d-lg-none d-block"></div>
                            </div>
                          </div>
                          <div class="col ">
                            <div class="vl-home-thumb">
                              ...
                              <a href="index3.html">Housa - Homepage 03</a>
                              <div class="btn-area1">
                                <a href="index3.html" class="vl-btn1">View Demo <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                              </div>
                              <div class="space20 d-lg-none d-block"></div>
                            </div>
                          </div>
                          <div class="col ">
                            <div class="vl-home-thumb">
                              ...
                              <a href="index4.html">Housa - Homepage 04</a>
                              <div class="btn-area1">
                                <a href="index4.html" class="vl-btn1">View Demo <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                              </div>
                              <div class="space20 d-lg-none d-block"></div>
                            </div>
                          </div>
                    ...
                    <ul class="sub-menu d-lg-none">
                      ...
                      <li><a href="index2.html">Homepage 02</a></li>
                      <li><a href="index3.html">Homepage 03</a></li>
                      <li><a href="index4.html">Homepage 04</a></li>
                    </ul>
                  </li>
                  <li class="has-dropdown">
                  ...
                  <li><a href="#">Listing <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                    <ul class="sub-menu">
                  ...
                  <li><a href="#">Properties <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                    <ul class="sub-menu">
                  ...
                  <li><a href="#">Dashboard <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                    <ul class="sub-menu">
          ...
          <div class="col-lg-2 col-md-6 col-6">
            <div class="vl-hero-btn d-none d-lg-block text-end">
              <div class="btn-area1">
                <a href="#" class="vl-btn1">Add Listing <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
            </div>
  ...
  <div class="property-half-grid-area sp1">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-3">
          <div class="sidebar1-area">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-home-tab1" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                  For Rent
                </button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link m-0" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false" tabindex="-1">
                  For Sale
                </button>
              </li>
            </ul>
            <div class="tab-content" id="pills-tabContent1">
              <div class="tab-pane fade show active" id="pills-home2" role="tabpanel" aria-labelledby="pills-home-tab1" tabindex="0">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="input-area m-0">
                      <select name="country" id="country1" class="country-area nice-select" style="display: none;">
                      ...
                      <div class="nice-select country-area" tabindex="0"><span class="current">All Cities</span>
                        <ul class="list">
                          <li data-value="1" data-display="All Cities" class="option selected">All Cities</li>
                          <li data-value="" class="option">Belgium</li>
                          <li data-value="" class="option">Brezil</li>
                          <li data-value="" class="option">Argentina</li>
                          <li data-value="" class="option">Bangladesh</li>
                          <li data-value="" class="option">Germany</li>
                        </ul>
                      </div>
                    </div>
                    <div class="input-area">
                      <select name="country" id="country2" class="country-area nice-select" style="display: none;">
                      ...
                      <div class="nice-select country-area" tabindex="0"><span class="current">Bedrooms</span>
                        <ul class="list">
                          <li data-value="1" data-display="Bedrooms" class="option selected">Bedrooms</li>
                          <li data-value="" class="option">01</li>
                          <li data-value="" class="option">02</li>
                          <li data-value="" class="option">03</li>
                          <li data-value="" class="option">04</li>
                          <li data-value="" class="option">05</li>
                        </ul>
                      </div>
                    </div>
                    <div class="input-area">
                      <select name="country" id="country3" class="country-area nice-select" style="display: none;">
                      ...
                      <div class="nice-select country-area" tabindex="0"><span class="current">Bathrooms</span>
                        <ul class="list">
                          <li data-value="1" data-display="Bathrooms" class="option selected">Bathrooms</li>
                          <li data-value="" class="option">01</li>
                          <li data-value="" class="option">02</li>
                          <li data-value="" class="option">03</li>
                          <li data-value="" class="option">04</li>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="btn-area1">
                      <a href="#" class="vl-btn1">Find Your Dream Property <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="input-area m-0">
                      <select name="country" id="country4" class="country-area nice-select" style="display: none;">
                        <option value="1" data-display="All Cities">All Cities</option>
                        <option value="">Belgium</option>
                        <option value="">Brezil</option>
                        <option value="">Argentina</option>
                    ...
                    <div class="input-area">
                      <select name="country" id="country5" class="country-area nice-select" style="display: none;">
                        <option value="1" data-display="Bedrooms">Bedrooms</option>
                        <option value="">01</option>
                        <option value="">02</option>
                        <option value="">03</option>
                    ...
                    <div class="input-area">
                      <select name="country" id="country6" class="country-area nice-select" style="display: none;">
                        <option value="1" data-display="Bathrooms">Bathrooms</option>
                        <option value="">01</option>
                        <option value="">02</option>
                        <option value="">03</option>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="btn-area1">
                      <a href="add-property.html" class="vl-btn1">Find Your Dream Property <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="tabs-btn">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                        <g clip-path="url(#clip0_6032_24145)">
                          <path
                            d="M5.30167 22.9045C5.44408 22.8969 5.58654 22.9184 5.72038 22.9676C5.85422 23.0169 5.97662 23.0928 6.08013 23.191C6.18363 23.2891 6.26606 23.4072 6.32239 23.5383C6.37872 23.6693 6.40777 23.8104 6.40777 23.953C6.40777 24.0956 6.37872 24.2367 6.32239 24.3677C6.26606 24.4988 6.18363 24.6169 6.08013 24.715C5.97662 24.8132 5.85422 24.8892 5.72038 24.9384C5.58654 24.9877 5.44408 25.0091 5.30167 25.0015H1.10617C0.963757 25.0091 0.821289 24.9877 0.68745 24.9384C0.553612 24.8892 0.431209 24.8132 0.327707 24.715C0.224206 24.6169 0.141776 24.4988 0.0854442 24.3677C0.0291127 24.2367 6.10352e-05 24.0956 6.10352e-05 23.953C6.10352e-05 23.8104 0.0291127 23.6693 0.0854442 23.5383C0.141776 23.4072 0.224206 23.2891 0.327707 23.191C0.431209 23.0928 0.553612 23.0169 0.68745 22.9676C0.821289 22.9184 0.963757 22.8969 1.10617 22.9045H5.30167ZM29.0062 22.9045C29.1486 22.8969 29.291 22.9184 29.4249 22.9676C29.5587 23.0169 29.6811 23.0928 29.7846 23.191C29.8881 23.2891 29.9706 23.4072 30.0269 23.5383C30.0832 23.6693 30.1123 23.8104 30.1123 23.953C30.1123 24.0956 30.0832 24.2367 30.0269 24.3677C29.9706 24.4988 29.8881 24.6169 29.7846 24.715C29.6811 24.8132 29.5587 24.8892 29.4249 24
6.10352e-05 5.19261 6.10352e-05 5.05C6.10352e-05 4.90739 0.0291127 4.76627 0.0854442 4.63525C0.141776 4.50424 0.224206 4.38607 0.327707 4.28796C0.431209 4.18985 0.553612 4.11385 0.68745 4.0646C0.821289 4.01535 0.963757 3.99388 1.10617 4.0015H5.30167ZM29.0062 4.0015C29.1486 3.99388 29.291 4.01535 29.4249 4.0646C29.5587 4.11385 29.6811 4.18985 29.7846 4.28796C29.8881 4.38607 29.9706 4.50424 30.0269 4.63525C30.0832 4.76627 30.1123 4.90739 30.1123 5.05C30.1123 5.19261 30.0832 5.33373 30.0269 5.46475C29.9706 5.59576 29.8881 5.71393 29.7846 5.81204C29.6811 5.91015 29.5587 5.98615 29.4249 6.0354C29.291 6.08465 29.1486 6.10612 29.0062 6.0985H8.34817C8.20576 6.10612 8.06329 6.08465 7.92945 6.0354C7.79561 5.98615 7.67321 5.91015 7.56971 5.81204C7.46621 5.71393 7.38378 5.59576 7.32744 5.46475C7.27111 5.33373 7.24206 5.19261 7.24206 5.05C7.24206 4.90739 7.27111 4.76627 7.32744 4.63525C7.38378 4.50424 7.46621 4.38607 7.56971 4.28796C7.67321 4.18985 7.79561 4.11385 7.92945 4.0646C8.06329 4.01535 8.20576 3.99388 8.34817 4.0015H29.0062Z"
                            fill="#424242" />
                        </g>
                        <defs>
                          <clipPath id="clip0_6032_24145">
                ...
                <div class="filter-group">
                  ...
                  <div class="nice-select" tabindex="0"><span class="current">Newest</span>
                    <ul class="list">
                      <li data-value="Sort by (Default)" class="option">Sort by (Default)</li>
                      <li data-value="Oldest" class="option">Oldest</li>
                      <li data-value="Newest" class="option selected focus">Newest</li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12">
                    <div class="property-single-boxarea">
                      <div class="property-list-img-area owl-carousel">
                        <div class="img1">
                          <a href="property-details-v1.html"><img src="assets/img/all-images/properties/property-img1.png" alt="housa"></a>
                        </div>
                        <div class="img1">
                          <a href="property-details-v1.html"><img src="assets/img/all-images/properties/property-img2.png" alt="housa"></a>
                        </div>
                        <div class="img1">
                          <a href="property-details-v1.html"><img src="assets/img/all-images/properties/property-img3.png" alt="housa"></a>
                        </div>
                      </div>
                      <div class="space20"></div>
                      ...
                      <div class="property-other-widget">
                        ...
                        <div class="btn-area">
                          ...
                          <div class="love-share">
                            <a href="javascript:void(0)" class="heart"><img src="assets/img/icons/heart2.svg" alt="housa" class="heart1"> <img src="assets/img/icons/heart1.svg" alt="housa" class="heart2"></a>
                  ...
                  <div class="col-lg-12">
                    <div class="btn-area1 text-center">
                      <a href="add-property.html" class="vl-btn1">View More Property <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <!--===== PROPERTY AREA ENDS =======-->
  <!--===== FOOTER AREA STARTS =======-->
  <div class="footer-cta-bg-area">
    <div class="cta1-section-area">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-10 m-auto">
            <div class="heading1 text-center">
              <h2>Let’s Make Your Property Dreams a Reality</h2>
              <div class="space16"></div>
              <p>Don’t wait to start your real estate journey. Whether you’re buying, selling, or renting, our expert <br class="d-lg-block d-none"> team is here to guide you every step of the way. Let’s turn your vision into reality with <br class="d-lg-block d-none"> personalized service and a seamless experience.</p>
              <div class="space32"></div>
              <div class="btn-area1">
                <a href="contact.html" class="vl-btn1">Start Your Search Today <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
            </div>
          </div>
        </div>
