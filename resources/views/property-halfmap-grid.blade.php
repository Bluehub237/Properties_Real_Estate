...
<!-- Mirrored from housa-html-demo.vercel.app/property-halfmap-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Oct 2025 12:24:54 GMT -->
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-2 col-md-6 col-6">
            <div class="vl-hero-btn d-none d-lg-block text-end">
              <div class="btn-area1">
                <a href="add-property.html" class="vl-btn1">Add Listing <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="property-single-boxarea">
                      ...
                      <div class="property-price">
                        <div class="text">
                          <a href="#" class="title">Golden Oaks Residence</a>
                  ...
                  <div class="col-lg-12">
                    <div class="btn-area1 text-center">
                      <a href="#" class="vl-btn1">View More Property <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>
                  </div>
                </div>
              </div>
