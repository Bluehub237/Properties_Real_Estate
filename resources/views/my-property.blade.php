...
<!-- Mirrored from housa-html-demo.vercel.app/my-property.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Oct 2025 12:24:26 GMT -->
          ...
          <div class="col-lg-3 col-md-6 col-6">
            <div class="vl-hero-btn d-none d-lg-block text-end">
              <div class="btn-area1 dashboard">
                ...
                <button class="hamburger_menu"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div class="sidebar-info">
        ...
        <div class="boxarea">
          <a href="dashboard.html">
            <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="col-lg-12">
          ...
          <div class="dashboad-all-details-section">
            ...
            <div class="row">
              ...
              <div class="space28"></div>
              <h4 class="found">60 Result Found</h4>
              <div class="space20"></div>
              <div class="table-container">
                ...
                <div class="table-row">
                  ...
                  <div class="status">
                    <a href="#" class="status-badge approved">Approved</a>
                  </div>
                  <div class="actions">
                    <button class="edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M6.41421 15.89L16.5563 5.74785L15.1421 4.33363L5 14.4758V15.89H6.41421ZM7.24264 17.89H3V13.6473L14.435 2.21231C14.8256 1.82179 15.4587 1.82179 15.8492 2.21231L18.6777 5.04074C19.0682 5.43126 19.0682 6.06443 18.6777 6.45495L7.24264 17.89ZM3 19.89H21V21.89H3V19.89Z"></path>
                      </svg> Edit</button>
                    <button class="sold"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <button class="delete"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="table-row">
                  ...
                  <div class="status">
                    <a href="#" class="status-badge sold">Sold</a>
                  </div>
                  <div class="actions">
                    <button class="edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M6.41421 15.89L16.5563 5.74785L15.1421 4.33363L5 14.4758V15.89H6.41421ZM7.24264 17.89H3V13.6473L14.435 2.21231C14.8256 1.82179 15.4587 1.82179 15.8492 2.21231L18.6777 5.04074C19.0682 5.43126 19.0682 6.06443 18.6777 6.45495L7.24264 17.89ZM3 19.89H21V21.89H3V19.89Z"></path>
