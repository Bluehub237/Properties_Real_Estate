      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="property-boxarea">
            ...
            <form action="{{ route('property.update', $property->id) }}" method="POST" id="propertyForm" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('PUT')
                @if(session('success'))
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                  ...
                  <div class="col-lg-12">
                    <div class="input-area">
                      <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $property->title) }}" placeholder="Tittle Name" required>
                    ...
                    <div class="space16"></div>
                    <div class="input-area">
                      <textarea name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Your Message">{{ old('description', $property->description) }}</textarea>
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-6">
                      ...
                      <div class="input-area">
                        ...
                        <div class="space16"></div>
                        <select class="nice-select @error('category') is-invalid @enderror" name="category" required>
                          <option value="Apartment" {{ old('category', $property->category) == 'Apartment' ? 'selected' : '' }}>Apartment</option>
                          <option value="Studio" {{ old('category', $property->category) == 'Studio' ? 'selected' : '' }}>Studio</option>
                          <option value="Bedroom" {{ old('category', $property->category) == 'Bedroom' ? 'selected' : '' }}>Bedroom</option>
                          <option value="Office" {{ old('category', $property->category) == 'Office' ? 'selected' : '' }}>Office</option>
                          <option value="Store" {{ old('category', $property->category) == 'Store' ? 'selected' : '' }}>Store</option>
                          <option value="Villa" {{ old('category', $property->category) == 'Villa' ? 'selected' : '' }}>Villa</option>
                        </select>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="input-area">
                          <h5>Price In FCFA</h5>
                          <div class="space16"></div>
                          <input type="text" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $property->price) }}" placeholder="Your Price" required>
                      ...
                      <div class="col-lg-4 col-md-6">
                        ...
                        <div class="input-area">
                          <h5>Deposit </h5>
                          <div class="space16"></div>
                          <input type="text" name="deposit" class="form-control @error('deposit') is-invalid @enderror" value="{{ old('deposit', $property->deposit) }}" placeholder="Deposit" required>
                      ...
                      <div class="col-lg-4 col-md-6">
                       ...
                       <div class="input-area">
                        <h5>Nbres de mois </h5>
                        <div class="space16"></div>
                        <select name="months" class="nice-select @error('months') is-invalid @enderror" required>
                          <option value="3" {{ old('months', $property->months) == 3 ? 'selected' : '' }}>3 months</option>
                          <option value="6" {{ old('months', $property->months) == 6 ? 'selected' : '' }}>6 months</option>
                          <option value="12" {{ old('months', $property->months) == 12 ? 'selected' : '' }}>12 months</option>
                        </select>
                      ...
                      <div class="col-lg-4 col-md-6">
                       ...
                       <div class="input-area">
                        <h5>Status </h5>
                        <div class="space16"></div>
                        <select name="status" class="nice-select @error('status') is-invalid @enderror" required>
                    ...
                    <div class="box-uploadfile text-center">
                      ...
                      <div class="box-img-upload">
                        <div class="item-upload file-delete" id="preview-1">
                          <img id="img-1" src="{{ asset('storage/' . json_decode($property->photos)[0]) }}" alt="housa" style="display: block;">
                        ...
                        <div class="item-upload file-delete" id="preview-2">
                          <img id="img-2" src="{{ asset('storage/' . json_decode($property->photos)[1]) }}" alt="housa" style="display: block;">
                        ...
                        <div class="item-upload file-delete" id="preview-3">
                          <img id="img-3" src="{{ asset('storage/' . json_decode($property->photos)[2]) }}" alt="housa" style="display: block;">
                        ...
                        <div class="item-upload file-delete" id="preview-4">
                          <img id="img-4" src="{{ asset('storage/' . json_decode($property->photos)[3]) }}" alt="housa" style="display: block;">
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                  <div class="upload-main-boxarea">
                    ...
                    <div class="input-area">
                      <h5>Address</h5>
                      <div class="space16"></div>
                      <input type="text" name="address" class="form-control @error('video') is-invalid @enderror" value="{{ old('address', $property->address) }}" placeholder="Property Address" required>
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                       ...
                       <div class="input-area">
                        <h5>City </h5>
                        <div class="space16"></div>
                        <select name="city" class="nice-select @error('city', $property->city) is-invalid @enderror" required>
                          <option value="Douala" {{ old('city', $property->city) == 'Douala' ? 'selected' : '' }}>Douala</option>
                          <option value="Yaoundé" {{ old('city', $property->city) == 'Yaoundé' ? 'selected' : '' }}>Yaoundé</option>
                        </select>
                      ...
                      <div class="col-lg-6 col-md-6">
                        ...
                        <div class="input-area">
                          <h5>Neighborhood*</h5>
                          <div class="space16"></div>
                          <input type="text" name="neighborhood" class="form-control @error('neighborhood') is-invalid @enderror" value="{{ old('neighborhood', $property->neighborhood) }}" placeholder="Neighborhood*" required>
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                        ...
                        <div class="input-area">
                          ...
                          <div class="space16"></div>
                          <input type="text" name="lot_size" class="form-control @error('lot_size') is-invalid @enderror" value="{{ old('lot_size', $property->lot_size) }}" placeholder="Lot size in ft (only numbers)" required>
                      ...
                      <div class="col-lg-4 col-md-6">
                        ...
                        <div class="input-area">
                          <h5>Room</h5>
                          <div class="space16"></div>
                          <input type="text" name="rooms" class="form-control @error('rooms') is-invalid @enderror" value="{{ old('rooms', $property->rooms) }}" placeholder="Rooms" required>
                      ...
                      <div class="col-lg-4 col-md-6">
                        ...
                        <div class="input-area">
                          <h5>Bedrooms</h5>
                          <div class="space16"></div>
                          <input type="text" name="bedrooms" class="form-control @error('bedrooms') is-invalid @enderror" value="{{ old('bedrooms', $property->bedrooms) }}" placeholder="Bedrooms" required>
                      ...
                      <div class="col-lg-4 col-md-6">
                        ...
                        <div class="input-area">
                          <h5>Bathrooms</h5>
                          <div class="space16"></div>
                          <input type="text" name="bathrooms" class="form-control @error('bathrooms') is-invalid @enderror" value="{{ old('bathrooms', $property->bathrooms) }}" placeholder="Bathrooms" required>
                      ...
                      <div class="col-lg-4 col-md-6">
                       ...
                       <div class="input-area">
                        ...
                        <select name="floors" class="nice-select @error('floors') is-invalid @enderror" required>
                          <option value="1" {{ old('floors', $property->floors) == 1 ? 'selected' : '' }}>1</option>
                          <option value="2" {{ old('floors', $property->floors) == 2 ? 'selected' : '' }}>2</option>
                          <option value="3" {{ old('floors', $property->floors) == 3 ? 'selected' : '' }}>3</option>
                          <option value="4" {{ old('floors', $property->floors) == 4 ? 'selected' : '' }}>4</option>
                        </select>
                    ...
                    <div class="row">
                      <div class="col-lg-2 col-md-6">
                        <fieldset class="checkbox-item style-1">
                          <label>
                            <input type="checkbox" name="amenities[]" value="Air Condition" {{ in_array('Air Condition', json_decode($property->amenities)) ? 'checked' : '' }}>
                        ...
                        <fieldset class="checkbox-item style-1">
                          <label>
                            <input type="checkbox" name="amenities[]" value="Parking" {{ in_array('Parking', json_decode($property->amenities)) ? 'checked' : '' }}>
                            <span class="btn-checkbox"></span>
                        ...
                        <fieldset class="checkbox-item style-1">
                          <label>
                            <input type="checkbox" name="amenities[]" value="Furnishing" {{ in_array('Furnishing', json_decode($property->amenities)) ? 'checked' : '' }}>
                            <span class="btn-checkbox"></span>
                      ...
                      <div class="col-lg-2 col-md-6">
                        <fieldset class="checkbox-item style-1">
                          <label>
                            <input type="checkbox" name="amenities[]" value="Floor" {{ in_array('Floor', json_decode($property->amenities)) ? 'checked' : '' }}>
                            <span class="btn-checkbox"></span>
                        ...
                        <fieldset class="checkbox-item style-1">
                          <label>
                            <input type="checkbox" name="amenities[]" value="Renovation" {{ in_array('Renovation', json_decode($property->amenities)) ? 'checked' : '' }}>
                            <span class="btn-checkbox"></span>
                        ...
                        <fieldset class="checkbox-item style-1">
                          <label>
                            <input type="checkbox" name="amenities[]" value="Cable TV" {{ in_array('Cable TV', json_decode($property->amenities)) ? 'checked' : '' }}>
                            <span class="btn-checkbox"></span>
                      ...
                      <div class="col-lg-2 col-md-6">
                        <fieldset class="checkbox-item style-1">
                          <label>
                            <input type="checkbox" name="amenities[]" value="Garden" {{ in_array('Garden', json_decode($property->amenities)) ? 'checked' : '' }}>
                            <span class="btn-checkbox"></span>
                        ...
                        <fieldset class="checkbox-item style-1">
                          <label>
                            <input type="checkbox" name="amenities[]" value="Wifi" {{ in_array('Wifi', json_decode($property->amenities)) ? 'checked' : '' }}>
                            <span class="btn-checkbox"></span>
