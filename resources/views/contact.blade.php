      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="phone-number">
            ...
            <div class="content">
              <p>Our Email</p>
              <a href="mailto:Housarealesate@gmail.com">kuatenael68@gmail.com</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="phone-number">
            ...
            <div class="content">
              <p>Phone</p>
              <a href="tel:+11234567890">+237 682 885 515</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="phone-number">
            ...
            <div class="content">
              <p>Schedule</p>
              <a href="tel:+11234567890">Monday-sunday: 8 AM – 6 PM</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="contact-boxarea">
            <div class="bg-area">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="input-area">
                    <input type="text" class="form-control @error('service') is-invalid @enderror" name="service" value="{{ old('service') }}" placeholder="Service (ex: Vente, Location, Autre)" required>
                    @error('service')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-lg-12">
                  <div class="input-area">
                    <textarea class="form-control @error('message') is-invalid @enderror" name="message" placeholder="Your Message">{{ old('message') }}</textarea>
                    @error('message')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
