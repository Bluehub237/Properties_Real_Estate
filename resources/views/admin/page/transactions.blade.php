...
<!-- Mirrored from techzaa.in/lahomes/admin/transactions.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Oct 2025 12:10:21 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
     <title>Transactions | Lahomes - Real Estate Management Admin Template</title>
     ...
     <link href="assets2/css/vendor.min.css" rel="stylesheet" type="text/css" />
     ...
     <script src="assets2/js/config.min.js"></script>
</head>
                                   ...
                                   <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end" aria-labelledby="page-header-notifications-dropdown">
                                        ...
                                        <div data-simplebar style="max-height: 280px;">
                                             ...
                                             <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                                                  <div class="d-flex">
                                                       <div class="flex-shrink-0">
                                                            <img src="assets2/images/users/avatar-1.jpg" class="img-fluid me-2 avatar-sm rounded-circle" alt="avatar-1" />
                                                       </div>
                                             ...
                                             <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                                  <div class="d-flex">
                                                       <div class="flex-shrink-0">
                                                            <img src="assets2/images/users/avatar-3.jpg" class="img-fluid me-2 avatar-sm rounded-circle" alt="avatar-3" />
                                                       </div>
                                                       <div class="flex-grow-1">
          ...
          <div class="main-nav">
               ...
               <div class="logo-box">
                    ...
                    <a href="index.html" class="logo-light">
                         <img src="assets2/images/logo-sm.png" class="logo-sm" alt="logo sm">
                         <img src="assets2/images/logo-light.png" class="logo-lg" alt="logo light">
                    </a>
               </div>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarProperty">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="property-grid.html">Property Grid</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="property-list.html">Property List</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="property-details.html">Property Details</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="property-add.html">Add Property</a>
                                        </li>
                                   </ul>
                              </div>
                         </li> <!-- end Pages Menu -->
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarAgents">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="agents-list.html">List View</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="agents-grid.html">Grid View</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="agents-details.html">Agent Details</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="agents-add.html">Add Agent</a>
                                        </li>
                                   </ul>
                              </div>
                         </li> <!-- end Pages Menu -->
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarCustomers">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="customers-list.html">List View</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="customers-grid.html">Grid View</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="customers-details.html">Customer Details</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="customers-add.html">Add Customer</a>
                                        </li>
                                   </ul>
                              </div>
                         </li> <!-- end Pages Menu -->
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarBlog">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="post.html">Post</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="post-details.html">Post Details</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="post-create.html">Create Post</a>
                                        </li>
                                   </ul>
                              </div>
                         </li> <!-- end Pages Menu -->
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarLayouts">
                                   <ul class="nav sub-navbar-nav">
                                        ...
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="layouts-small-hover-active.html" target="_blank">Small Hover Active</a>
                                        </li>
                                        <li class="sub-nav-item">
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarIcons">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="icons-remix.html">Remix Icons</a>
                                        </li>
                                        <li class="sub-nav-item">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="mb-0 fw-semibold">Transactions</h4>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <a href="#!" class="rounded-circle">
                                                                           <div class="position-relative">
                                                                                <img src="assets2/images/users/avatar-2.jpg" alt="" class="avatar-sm rounded-circle flex-shrink-0 ">
                                                            ...
                                                            <td>
                                                                 <div class="d-flex gap-2">
                                                                      <div>
                                                                           <img src="assets2/images/card/mastercard.svg" alt="" class="avatar-xs">
                                                                      </div>
                                                                      <div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <a href="#!" class="rounded-circle">
                                                                           <div class="position-relative">
                                                                                <img src="assets2/images/users/avatar-3.jpg" alt="" class="avatar-sm rounded-circle flex-shrink-0 ">
                                                                                <span class="position-absolute bottom-0 end-0  rounded-circle">
                                                                                     <span class=""><i class="ri-circle-fill fs-10 align-bottom text-success bg-light rounded-circle"></i></span>
                                                                                </span>
                                                                           </div>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex gap-2">
                                                                      <div>
                                                                           <img src="assets2/images/card/visa.svg" alt="" class="avatar-xs">
                                                                      </div>
                                                                      <div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <a href="#!" class="rounded-circle">
                                                                           <div class="position-relative">
                                                                                <img src="assets2/images/users/avatar-4.jpg" alt="" class="avatar-sm rounded-circle flex-shrink-0 ">
                                                                                <span class="position-absolute bottom-0 end-0  rounded-circle">
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <a href="#!" class="rounded-circle">
                                                                           <div class="position-relative">
                                                                                <img src="assets2/images/users/avatar-5.jpg" alt="" class="avatar-sm rounded-circle flex-shrink-0 ">
                                                                                <span class="position-absolute bottom-0 end-0  rounded-circle">
                                                            ...
                                                            <td>
                                                                 <div class="d-flex gap-2">
                                                                      <div>
                                                                           <img src="assets2/images/card/paypal.svg" alt="" class="avatar-xs">
                                                                      </div>
                                                                      <div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <a href="#!" class="rounded-circle">
                                                                           <div class="position-relative">
                                                                                <img src="assets2/images/users/avatar-6.jpg" alt="" class="avatar-sm rounded-circle flex-shrink-0 ">
                                                                                <span class="position-absolute bottom-0 end-0  rounded-circle">
                                                                                     <span class=""><i class="ri-circle-fill fs-10 align-bottom text-success bg-light rounded-circle"></i></span>
                                                                                </span>
                                                                           </div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <a href="#!" class="rounded-circle">
                                                                           <div class="position-relative">
                                                                                <img src="assets2/images/users/avatar-7.jpg" alt="" class="avatar-sm rounded-circle flex-shrink-0 ">
                                                                                <span class="position-absolute bottom-0 end-0  rounded-circle">
                                                                                     <span class=""><i class="ri-circle-fill fs-10 align-bottom text-warning bg-light rounded-circle"></i></span>
                                                                                </span>
                                                                           </div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <a href="#!" class="rounded-circle">
                                                                           <div class="position-relative">
                                                                                <img src="assets2/images/users/avatar-8.jpg" alt="" class="avatar-sm rounded-circle flex-shrink-0 ">
                                                                                <span class="position-absolute bottom-0 end-0  rounded-circle">
                                                                                     <span class=""><i class="ri-circle-fill fs-10 align-bottom text-success bg-light rounded-circle"></i></span>
                                                                                </span>
                                                                           </div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      <a href="#!" class="rounded-circle">
                                                                           <div class="position-relative">
                                                                                <img src="assets2/images/users/avatar-9.jpg" alt="" class="avatar-sm rounded-circle flex-shrink-0 ">
                                                                                <span class="position-absolute bottom-0 end-0  rounded-circle">
                                                                                     <span class=""><i class="ri-circle-fill fs-10 align-bottom text-danger bg-light rounded-circle"></i></span>
                                                                                </span>
                                                                           </div>
                                        ...
                                        <div class="card border-0 mb-0 shadow-none">
                                             <div class="card-body p-0 pb-3">
                                                  <div class="d-flex align-items-center gap-3">
                                                       <a href="#!" class="rounded-circle">
                                                            <div class="position-relative">
                                                                 <img src="assets2/images/users/avatar-2.jpg" alt="" class="avatar-md rounded-circle flex-shrink-0 img-thumbnail">
                                                                 <span class="position-absolute bottom-0 end-0  rounded-circle">
                                                  ...
                                                  <div class="p-3 bg-primary bg-gradient rounded-4 mt-4 border border-light border-2 shadow-sm">
                                                       <div class="d-flex align-items-center">
                                                            <img src="assets2/images/chip.png" alt="" class="avatar">
                                                            <div class="ms-auto">
                                                                 <img src="assets2/images/card/mastercard.svg" alt="" class="avatar">
                                                            </div>
                                                       </div>
                                                       <div class="mt-5">
                                                       ...
                                                       <div class="d-flex align-items-center justify-content-between mt-4">
                                                            ...
                                                            <img src="assets2/images/contactless-payment.png" alt="" class="img-fluid">
                                                       </div>
                                                  </div>
                                                  <div class="mt-4">
...
<!-- Mirrored from techzaa.in/lahomes/admin/transactions.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Oct 2025 12:10:22 GMT -->
</html>
